...
TEACHER_CKPT_NAME="DeepSeek-R1-Distill-Qwen-7B"
TEACHER_CKPT="deepseek-ai/DeepSeek-R1-Distill-Qwen-7B"
# data
DATA_DIR="${BASE_PATH}/processed_data/MetaMathQA-50k-deepseek/qwen/"
# hp
BATCH_SIZE=4
LR=0.0001
GRAD_ACC=4
...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/deepseek/nnm_0.5B_1.5B_math"
# seed
SEED=42
